...
ALTER TABLE visit ADD CONSTRAINT chk_visit_length CHECK (visit_length BETWEEN 30
AND 90);

ALTER TABLE visit
ADD CONSTRAINT uq_visit_date_time_animal_id UNIQUE (visit_date_time, animal_id);
...
ALTER TABLE visit_drug
ADD CONSTRAINT visit_fk FOREIGN KEY (visit_id) 
REFERENCES visit (visit_id);

ALTER TABLE visit_drug
ADD CONSTRAINT drug_fk FOREIGN KEY (drug_id)
REFERENCES drug (drug_id);


ALTER TABLE visit_service
ADD CONSTRAINT service_visit_fk FOREIGN KEY (visit_id)
REFERENCES visit (visit_id);
